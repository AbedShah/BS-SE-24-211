                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'gkd2qyrk' /* Below are a list of Users of y... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                                ...
                                                children: [
                                                  Container(
                                                    decoration: BoxDecoration(
                                                      ...
                                                      border: Border.all(
                                                        color: () {
                                                          if (listViewUsers1Record
                                                                  .roll ==
                                                              'Owner') {
                                                            return FlutterFlowTheme
                                                                    .of(context)
                                                                .primary;
                                                          } else if (listViewUsers1Record
                                                                  .roll ==
                                                              'Renter') {
                                                            return FlutterFlowTheme
                                                                    .of(context)
