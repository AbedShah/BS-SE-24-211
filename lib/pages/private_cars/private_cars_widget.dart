...
import '/comp/language_options/language_options_widget.dart';
...
import 'private_cars_model.dart';
export 'private_cars_model.dart';

class PrivateCarsWidget extends StatefulWidget {
  const PrivateCarsWidget({super.key});

  @override
  State<PrivateCarsWidget> createState() => _PrivateCarsWidgetState();
}

class _PrivateCarsWidgetState extends State<PrivateCarsWidget> {
  late PrivateCarsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PrivateCarsModel());
  }
                            ...
                            builder: (context) {
                              return GestureDetector(
                                ...
                                child: Padding(
                                  ...
                                  child: const LanguageOptionsWidget(),
                                ),
                              );
                            },
