...
import 'wedding_cars_model.dart';
export 'wedding_cars_model.dart';

class WeddingCarsWidget extends StatefulWidget {
  const WeddingCarsWidget({super.key});

  @override
  State<WeddingCarsWidget> createState() => _WeddingCarsWidgetState();
}

class _WeddingCarsWidgetState extends State<WeddingCarsWidget> {
  late WeddingCarsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WeddingCarsModel());
  }
