...
import 'luxury_cars_model.dart';
export 'luxury_cars_model.dart';

class LuxuryCarsWidget extends StatefulWidget {
  const LuxuryCarsWidget({super.key});

  @override
  State<LuxuryCarsWidget> createState() => _LuxuryCarsWidgetState();
}

class _LuxuryCarsWidgetState extends State<LuxuryCarsWidget> {
  late LuxuryCarsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LuxuryCarsModel());
  }
