...
import 'family_cars_model.dart';
export 'family_cars_model.dart';

class FamilyCarsWidget extends StatefulWidget {
  const FamilyCarsWidget({super.key});

  @override
  State<FamilyCarsWidget> createState() => _FamilyCarsWidgetState();
}

class _FamilyCarsWidgetState extends State<FamilyCarsWidget> {
  late FamilyCarsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FamilyCarsModel());
  }
