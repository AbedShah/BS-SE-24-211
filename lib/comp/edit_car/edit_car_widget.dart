              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'fcvjddae' /* Below are your Car details */,
                      ),
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await widget.car!.reference
                                ...
                                rentPrice: int.tryParse(
                                    _model.yourNameTextController1.text),
                                timeAvalibale: widget.car?.timeAvalibale,
                              ));
                              context.pop();
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    'You successfully updated your Car information!',
