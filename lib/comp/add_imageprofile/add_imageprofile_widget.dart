...
import 'add_imageprofile_model.dart';
export 'add_imageprofile_model.dart';
...
class _AddImageprofileWidgetState extends State<AddImageprofileWidget>
  ...
  late AddImageprofileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddImageprofileModel());
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'hij9s32q' /* Add profile Photo Please */,
                      ),
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await currentUserReference!
                                ...
                                imagePorfile: _model.uploadedFileUrl,
                              ));
                              context.pop();
