...
import 'schema/cars_for_rent_record.dart';
...
export 'schema/cars_for_rent_record.dart';
...
/// Functions to query CarsForRentRecords (as a Stream and as a Future).
Future<int> queryCarsForRentRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CarsForRentRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CarsForRentRecord>> queryCarsForRentRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CarsForRentRecord.collection,
      CarsForRentRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CarsForRentRecord>> queryCarsForRentRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
